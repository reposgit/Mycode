...
{{--        <div class="form-group">--}}
{{--            <label for="name">Имя: *</label>--}}
{{--            <input class="form-control" placeholder="Имя" name="name" type="text" id="name" value={{$message->name}}>--}}
{{--        </div>--}}

{{--        <div class="form-group">--}}
{{--            <label for="email">E-mail:</label>--}}
{{--            <input class="form-control" placeholder="E-mail" name="email" type="email" id="email" value={{$message->email}}>--}}
{{--        </div>--}}

{{--        <div class="form-group">--}}
{{--            <label for="message">Сообщение: *</label>--}}
{{--            <textarea class="form-control" rows="5" placeholder="Текст сообщения" name="message" cols="50"--}}
{{--                      id="message" value={{$message->message}}></textarea>--}}
{{--        </div>--}}
